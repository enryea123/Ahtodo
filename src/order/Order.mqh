...
#define SETTER(T, V, V_) private: string V_; public: void V(T V) {V_ = StringConcatenate(V_, ", ", V);}
#define SETTER_OL2(T, V) void V(T V1, T V2) {V(V1); V(V2);}
#define SETTER_OL3(T, V) void V(T V1, T V2, T V3) {V(V1); V(V2); V(V3);}
#define SETTER_OL4(T, V) void V(T V1, T V2, T V3, T V4) {V(V1); V(V2); V(V3); V(V4);}
#define SETTER_OL5(T, V) void V(T V1, T V2, T V3, T V4, T V5) {V(V1); V(V2); V(V3); V(V4); V(V5);}
...
#define FILTER(N, T, V, V_) SETTER(T, V, V_) SETTER_OVERLOADS(T, V) GETTER(N, T, V, V_)
