...
const double MIN_TAKEPROFIT_FACTOR = 0.8;
...
Map<int, double> BREAKEVEN_SUFFERING_INTERVALS;
...
void InitializeMaps() {
    ...
    BREAKEVEN_SUFFERING_INTERVALS.put(15, 0.75);
    BREAKEVEN_SUFFERING_INTERVALS.put(30, 0.5);
    BREAKEVEN_SUFFERING_INTERVALS.put(45, 0.25);
    BREAKEVEN_SUFFERING_INTERVALS.put(60, 0);
    BREAKEVEN_SUFFERING_INTERVALS.lock();
