...
const int EXTREMES_MAX_CANDLES = 400;

const int PATTERN_MINIMUM_SIZE_PIPS = 8;
const int PATTERN_MAXIMUM_SIZE_PIPS = 19;

const int STOPLOSS_MAXIMUM_SIZE_PIPS = 20;
...
const int ORDER_ENTRY_POINT_CANDLES = 3;
const int ORDER_CANDLES_DURATION = 8;
...
Map<int, int> TRAILING_STEPS;
Map<int, double> PERCENT_RISK_ACCOUNT;
Map<string, double> PERCENT_RISK_SYMBOL;
...
void InitializeMaps() {
    ...
    TRAILING_STEPS.put(0, 4);
    TRAILING_STEPS.put(2, 2);
    TRAILING_STEPS.put(3, 1);
    TRAILING_STEPS.put(4, 0);
    TRAILING_STEPS.lock();

    PERCENT_RISK_ACCOUNT.put(2100183900, 2.0);
    PERCENT_RISK_ACCOUNT.lock();

    PERCENT_RISK_SYMBOL.put("EURJPY", 0.5);
    PERCENT_RISK_SYMBOL.put("EURUSD", 0.05);
    PERCENT_RISK_SYMBOL.put("GBPCHF", 1.0);
    PERCENT_RISK_SYMBOL.put("GBPUSD", 0.05);
    PERCENT_RISK_SYMBOL.put("USDJPY", 0.5);
    PERCENT_RISK_SYMBOL.lock();
    ...
    RESTRICTED_SYMBOLS.put("NOKSEK", PERIOD_H4);
